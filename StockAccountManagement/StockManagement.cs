...
namespace StockAccountManagement
{
    class StockManagement
    {
        public void BuyStocks(Customer customerRecords)
        {
            ...
            Stocks stockAccount = JsonConvert.DeserializeObject<Stocks>(File.ReadAllText(@"D:\tvstraining\StockAccountManagement\StockAccountManagement\StockDetails.json"));
            ...
            if (numberOfShares <= stockName.NumberOfShares)
            {
                ...
                if (cost <= marked.Amount)
                {
                    ...
                    if (proceed == 'Y' || proceed == 'y')
                    {
                        ...
                        File.WriteAllText(@"D:\tvstraining\StockAccountManagement\StockAccountManagement\CustomerDetails.json", JsonConvert.SerializeObject(customerRecords));
                        File.WriteAllText(@"D:\tvstraining\StockAccountManagement\StockAccountManagement\StockDetails.json", JsonConvert.SerializeObject(stockAccount));
                        File.WriteAllText(@"D:\tvstraining\StockAccountManagement\StockAccountManagement\TransactionDetails.json", JsonConvert.SerializeObject(transaction));
        ...
        {
            Customer customerRecords = JsonConvert.DeserializeObject<Customer>(File.ReadAllText(@"D:\tvstraining\StockAccountManagement\StockAccountManagement\CustomerDetails.json"));
            foreach (Customer.CustomerRecords customer in customerRecords.CustomerRecordsList)
            {
